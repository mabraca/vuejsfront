  ...
  <div class="md-layout text-center login-fix-page">
    <div class="md-layout-item md-size-100">
      ...
      <div class="text-center" style="margin-bottom: 32px;">
        <h5><strong>Puedes loguearte con elos siguientes datos por default</strong></h5>
        <div>Email <b>admin@jsonapi.com</b> Password <b>secret</b></div>
      </div>
    </div>
    ...
    >
      <form @submit.prevent="login">
        <login-card header-color="green">
          <h4 slot="title" class="title">Visita nuestras redes sociales:</h4>
          <md-button
            slot="buttons"
            ref="#facebook"
          ...
          <p slot="description" class="description">Ingresa tus datos</p>
          <md-field
