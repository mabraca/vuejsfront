    ...
    <md-toolbar md-elevation="0" class="md-transparent md-toolbar-absolute">
      <div class="md-toolbar-row md-offset">
        <div class="md-toolbar-section-start">
          <h3 class="md-title">Página de Posts</h3>
        </div>
        <div class="md-toolbar-section-end">
          ...
          >
            <md-list>
              ...
              <md-list-item href="/admin" @click="linkClick" v-if="!$store.getters['isAuthenticated']">
...
export default {
  ...
  computed: {
    setBgImage() {
      return {
        backgroundImage: `url(${require('../../../assets/images/paisaje.jpg')})`
      };
    },
    setPageClass() {
